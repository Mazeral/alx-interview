...
Each row corresponds to the binomial coefficients of the expansion of (a + b)^n.
...
def pascal_triangle(n):
    ...
    if n <= 0:
        ...
        pascal = []  # Initialize an empty list to store the rows of Pascal's Triangle
        for i in range(n):
            ...
            pascal.append(pascal_array)  # Add the current row to Pascal's Triangle
